...
const scrollToBottom = () => {
  const chatSection = document.querySelector('#message-section');
  if (chatSection) {
...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col h-screen text-slate-700">
      <header className=" flex justify-between items-center h-14 px-6 py-2 border-b border-slate-900/10 bg-slate-50">
        <h1 className="hidden lg:block font-semibold text-xl">Chat Application</h1>
      ...
      <main className="flex flex-row flex-grow">
        ...
        <div className="flex-grow flex flex-col">
          ...
          {/* Message section */}
          <div className="flex flex-col flex-grow h-[calc(100vh-11rem)] gap-2 px-6 py-4 overflow-y-auto border-y border-slate-900/10 bg-slate-100" id="message-section">
          ...
          <div className="flex gap-4 bg-slate-50 px-6 py-4">
            ...
            <Button primary className="material-symbols-rounded px-2 py-1">
              send
            </Button>
          </div>
        </div>
